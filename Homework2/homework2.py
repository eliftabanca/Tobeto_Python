...
# sayi1 = int(input("Enter first positive integer: "))
# sayi2 = int(input("Enter second positive integer: "))
...
# print(f"EBOB of the numbers entered: {ebob}")
# print(f"EKOK of the numbers entered: {ekok}")    
